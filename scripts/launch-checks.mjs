...
check('research planner handles Codex and Claude Code comparisons', /OpenAI Codex official documentation/.test(researchPlanner) && /Anthropic Claude Code official documentation/.test(researchPlanner) && /Anthropic Claude Opus 4\.8 official/.test(researchPlanner));
...
check('model comparison search keeps sources from both sides', /diversifyComparisonResults/.test(searchLib) && /sourceFamily/.test(searchLib) && /addRepresentativeResult/.test(searchLib));
